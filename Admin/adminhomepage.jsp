<%-- 
    ...
    Created on : Feb 9, 2018, 2:17:31 PM
    Author     : ckc
--%>
         ...
         <a href="Place.jsp">Add Place</a><br><br>
          <a href="BookingType.jsp">Add Booking Type</a><br><br>
           ...
           <a href="TechnicianType.jsp">Add Technician Type</a><br><br>
            ...
            <a href="BuildersApprovedList.jsp">View Builders Approved list</a><br>
            <a href="BuilderRejectedList.jsp">View Builders Rejection List</a><br><br>
