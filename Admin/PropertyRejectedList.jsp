<%-- 
    Document   : PropertyRejectedList
    Created on : 1 Mar, 2018, 2:27:30 PM
    ...
    <body>
        <form name="frm_reject">
                ...
                <th>Description</th>
                     ...
                     <% int i=1;
                    String str="select * from tbl_property p inner join tbl_district d on p.district_id = d.district_id inner join tbl_constructiontype t on p.constructiontype_id = t.constructiontype_id where property_status=2";
