    ...
    <body>
        ...
        <%
            ...
            if(request.getParameter("btnsubmit")!=null)
            {
                ...
                {
                   String sel="select l.login_id from tbl_login l inner join tbl_technicians t on l.login_id=t.login_id where l.login_password='"+current+"' and t.technician_id='"+session.getAttribute("technicianid")+"'";
